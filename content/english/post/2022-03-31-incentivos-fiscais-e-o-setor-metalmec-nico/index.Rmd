...
O município de Macaé, por exemplo, possui 23 empresas, mesmo não possuindo benefício fiscal. Enquanto que dois municípios vizinhos (Carapebus e Conceição de Macabu) são áreas abrangidas pelo benefício da Lei 6.979/15 mas possuem apenas 4 empresas ao todo. Mesmo sendo municípios limítrofes, a grande maioria das empresas preferiu continuar em Macaé (observe, agora, a cidade do Rio de Janeiro com 143 empresas!).
...
Por fim, cabe destacar que a Lei 8.960/20 redefine o conceito de industrialização, permitindo que o corte da chapa seja considerado industrialização. Isso pode fazer com que uma etapa muito simples de industrialização, que gera poucos empregos, reduza a arrecadação de uma cadeia mais complexa (fabricação da chapa em si). Ou seja, uma grande empresa (como a CSN, por exemplo) nada vai pagar de ICMS porque alguma empresa vai alegar que irá cortar a bobina e depois mandar cortada ao meio para SP, que ficará com todos os empregos da indústrialzação de fato (transformar a chapa em algo mais complexo).
