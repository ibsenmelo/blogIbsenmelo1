...
O município de Macaé, por exemplo, possui 23 empresas, mesmo não possuindo benefício fiscal. Enquanto que o município vizinho Carapebus^[A lista de municípios abrangidos pelo benefício descrito na Lei 6.979/15 vêm se ampliando ao longo do tempo (vide Lei 9.335/21 que novamente ampliou esta listagem). Mas o município citado no exemplo (Carapebus) possui o referido benefício desde 2005, quando entrou em vigor a Lei 4.533/05.] é área abrangida pelo benefício da Lei 6.979/15 mas possue apenas 3 empresas ao todo. Mesmo sendo municípios limítrofes, a grande maioria das empresas preferiu continuar em Macaé (agora observe a cidade do Rio de Janeiro com 143 empresas!).
...
Por fim, cabe destacar que a Lei 8.960/20 redefine o conceito de industrialização, permitindo que o corte da chapa seja considerado industrialização. Isso pode fazer com que uma etapa muito simples de industrialização, que gera poucos empregos, reduza a arrecadação de uma cadeia mais complexa (fabricação da chapa em si). Ou seja, uma grande empresa (como a CSN, por exemplo) nada vai pagar de ICMS porque alguma empresa vai alegar que irá cortar a bobina e depois mandar cortada ao meio para outro estado, que ficará com todos os empregos da indústrialzação de fato (transformar a chapa em algo mais complexo).
